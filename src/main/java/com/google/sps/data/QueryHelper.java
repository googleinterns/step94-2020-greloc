...
public class QueryHelper {
  ...
  /**
   * Returns a list of entities that have been filtered based on their longitude in relation to the selected office's longitude
   *
   ...
   */
  public static List<Entity> getDistanceBasedEntities(EntityType entityType, int entityLimit, Office selectedOffice, double kilometers) {
